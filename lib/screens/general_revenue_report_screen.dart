...
class _GeneralRevenueReportScreenState extends State<GeneralRevenueReportScreen> {
  ...
  Future<QuerySnapshot<Map<String, dynamic>>> _fetchVehicleDataForGeneralReport(DateTime startDate, DateTime adjustedEndDate) async {
    return _firestore
        .collection(FirestoreCollections.vehicles) // Use constant
        .where('status', isEqualTo: VehicleStatuses.completed) // Use constant
  ...
  Map<String, dynamic> _processGeneralReportData(QuerySnapshot<Map<String, dynamic>> vehicleSnapshot) {
